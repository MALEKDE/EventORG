...
try {
    ...
    json_response(true, 'Event created successfully', [
        'event_id' => (int)$pdo->lastInsertId()
    ]);

} catch (PDOException $e) {
    json_response(false, 'Failed to create event', [], 500);
}
?>
